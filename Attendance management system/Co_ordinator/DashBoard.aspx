<%@ Page Title="" Language="C#" MasterPageFile="~/Co_ordinator/Co_ordinator.Master" AutoEventWireup="true" CodeFile="DashBoard.aspx.cs" Inherits="Attendance_management_system.Co_ordinator.DashBoard" %>
        ...
        <div class="container mt-3">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:AMSConnectionString %>' SelectCommand="SELECT [NotificationTitle] FROM [Notification] WHERE (([Notofication_To] = @Notofication_To) OR ([Notofication_To] = @Notofication_To2))">
                <selectparameters>
                    ...
                    <asp:Parameter DefaultValue="co-ordinator" Name="Notofication_To2" Type="String"></asp:Parameter>
                </selectparameters>
            </asp:SqlDataSource>
        </div>
    </div>
