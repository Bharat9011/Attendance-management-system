<%@ Page Title="" Language="C#" MasterPageFile="~/HOD/HOD.Master" AutoEventWireup="true" CodeFile="ShowNotification.aspx.cs" Inherits="Attendance_management_system.HOD.ShowNotification" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" CssClass="table table-bordered table-striped table-hover table-responsive rounded" OnSelectedIndexChanging="GridView1_SelectedIndexChanging">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Notofication To">
                <ItemTemplate>
                    <asp:Label ID="Label4" runat="server" Text='<%# Eval("Notofication_To") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:CommandField ShowSelectButton="True" HeaderText="Show Notification" SelectText="View" />
        </Columns>
    </asp:GridView>
