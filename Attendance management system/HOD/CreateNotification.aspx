<%@ Page Title="" Language="C#" MasterPageFile="~/HOD/HOD.Master" AutoEventWireup="true" CodeFile="CreateNotification.aspx.cs" Inherits="Attendance_management_system.HOD.CreateNotification" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group mt-2">
        ...
        <asp:DropDownList class="form-control" ID="To" runat="server">
            <asp:ListItem>All (Teacher,Co-ordinator, Student)</asp:ListItem>
